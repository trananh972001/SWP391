            ...
            <div class="py-5 md:py-0">
                ...
                <div class="flex overflow-hidden">
                  <%@include file="DashboardSider.jsp" %>
                    <div class="content">
                        <h2 class="intro-y text-lg font-medium mt-10">Edit Lesson</h2>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible" style="overflow-x: auto">
                                <form action="EditLessonDetail?id=${getLessonByDetail.id}" method="post">
                                    ...
                                    <thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control" type="text" name="TopicID" value="${getLessonByDetail.topicID}"   aria-label="default input example">
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea rows="" cols="" id="content" name="Video" style="width: 820px;height: 175px;">${getLessonByDetail.videolink}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
