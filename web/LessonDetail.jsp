        ...
        <div id="root">
            <div class="py-5 md:py-0">
                ...
                <div class="flex overflow-hidden">
                    ...
                    <div class="content">
                        <h2 class="intro-y text-lg font-medium mt-10">Lesson Detail</h2>
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                                <form action="UserListAdd.jsp" method="post">
                                    <button
                                        class="btn btn-primary shadow-md mr-2">Add New User</button>
                                </form>
                                ...
                                <table class="table table-report -mt-2">
                                        <thead>
                                            <tbody>
                                                <tr>
                                                    <th >Title</th>
                                                    <td scope="row">${getLessonByDetail.title}</td>
                                                </tr>
                                                 <tr>
                                                    <th >TopicID</th>
                                                    <td >${getLessonByDetail.topicID}</td>
                                                </tr>
                                                 <tr>
                                                    <th>Type</th>
                                                ...
                                                <tr>
                                                    <th >Order</th>
                                                    <td scope="row">${getLessonByDetail.order}</td>
                                                </tr>
                                                
                                            </tbody>
                                                <td><button style="color: red;color: white;background-color: #006dcc;font-style: oblique;font-weight: bold;border-radius: 10px;width: 150px;height: 50px;" type="submit"><a href="EditLessonDetail?id=${getLessonByDetail.id}">Edit Lesson</a> </button></td>
                                            </thead>
                                </table>
                            </div>
