            ...
            <div class="py-5 md:py-0">
                ...
                <div class="flex overflow-hidden">
                   <%@include file="DashboardSider.jsp" %>
                    <div class="content">
                        <h2 class="intro-y text-lg font-medium mt-10">Add lesson</h2>
                                        ...
                                        <thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text" name="TopicID" minlength="1" maxlength="50" required="" aria-label="default input example">
                                                    </td>
