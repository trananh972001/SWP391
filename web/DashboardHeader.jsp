<%-- 
    ...
    Created on : Jun 14, 2022, 7:35:58 PM
    Author     : nguye
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    <head>
        ...
        <meta charset="UTF-8">
        <link rel="icon" type="image/svg+xml" href="assets/cssDashboard/images/logo.svg">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Midone - React Admin Template</title>
        <script type="module" crossorigin="" src="assets/cssDashboard/cssDashboard/index.867e1523.js"></script>
        <link rel="stylesheet" href="assets/cssDashboard/index.1880057a.css">
        <style data-cke="true">
            .ck-hidden {
        ...
        <script id="__googleMapsScriptId" type="text/javascript"
                src="https://maps.googleapis.com/maps/api/js?callback=__googleMapsCallback&amp;key=AIzaSyBG7gNHAhDzgYmq4-EHvM4bqW1DNj2UCuk"
        defer="" async=""></script>
        <style></style>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/common.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/util.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/map.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/marker.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/overlay.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/stats.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/onion.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/infowindow.js"></script>
        <script type="text/javascript" charset="UTF-8"
        src="https://maps.googleapis.com/maps-api-v3/api/js/49/4/controls.js"></script>
    </head>
